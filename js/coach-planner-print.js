...
(function (global) {
  ...
  function printCss() {
    return [
      ...
      '.brand-name{font-weight:800;letter-spacing:.04em;text-transform:uppercase;font-size:8pt;color:var(--blue)}',
      '.head h1{font-size:18pt;font-weight:800;line-height:1.15;margin-top:2px}',
      '.meta{text-align:right;font-size:9pt;font-weight:600;color:var(--muted);line-height:1.4;max-width:42%}',
      '.say{margin:10pt 0 8pt;padding:8pt 12pt;background:var(--tint);border-left:4px solid var(--gold);-webkit-print-color-adjust:exact;print-color-adjust:exact}',
      '.say span{display:block;font-size:8pt;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:var(--blue)}',
      '.say strong{display:block;margin-top:3pt;font-size:14pt;font-weight:700;line-height:1.3}',
      '.cues{display:grid;gap:8pt;margin:8pt 0}',
      '.cue{border:1px solid var(--line);border-radius:8px;padding:7pt 8pt;font-size:11pt;line-height:1.35}',
      '.cue b{display:block;color:var(--blue);font-size:11pt;margin-bottom:2pt}',
      '.why{margin:0 0 10pt;font-size:10pt;line-height:1.45;color:var(--ink)}',
      '.hour{margin-top:2pt}',
      '.hour h2{font-size:8pt;font-weight:700;letter-spacing:.14em;text-transform:uppercase;color:var(--blue);margin-bottom:2pt}',
      '.step{display:grid;grid-template-columns:58pt 1fr;gap:8pt;padding:6pt 0;border-bottom:1px solid #e6e8ee;break-inside:avoid;page-break-inside:avoid}',
      '.step:last-child{border-bottom:0}',
      '.step-time{font-weight:800;color:var(--blue);font-variant-numeric:tabular-nums;font-size:10.5pt}',
      '.step-label{font-weight:700;font-size:11pt}',
      '.step-detail{margin-top:1pt;font-size:10.5pt;line-height:1.4;color:var(--ink)}',
      '.band{display:grid;gap:8pt;margin-top:10pt}',
      '.band article{background:var(--tint);border-radius:8px;padding:7pt 8pt;break-inside:avoid;page-break-inside:avoid;-webkit-print-color-adjust:exact;print-color-adjust:exact}',
      '.band h3{font-size:8pt;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:var(--blue);margin-bottom:3pt}',
      '.band p{margin:0;font-size:10pt;line-height:1.4}',
      '.band ul{margin:0 0 0 12pt;padding:0;font-size:10pt;line-height:1.4}',
      '.band li{margin:0 0 2pt}',
      '.note{margin-top:8pt;padding:6pt 10pt;border-left:3px solid var(--blue);background:var(--tint);font-size:10.5pt;-webkit-print-color-adjust:exact;print-color-adjust:exact;break-inside:avoid}',
      '.note strong{display:block;font-size:8pt;letter-spacing:.1em;text-transform:uppercase;color:var(--blue);margin-bottom:2pt}',
      '.quiet{margin-top:8pt;font-size:8.5pt;line-height:1.45;color:var(--muted)}',
      '.foot{margin-top:6pt;text-align:center;font-size:8pt;color:#888}',
